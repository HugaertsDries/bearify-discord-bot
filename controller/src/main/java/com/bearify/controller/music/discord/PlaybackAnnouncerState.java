...
public final class PlaybackAnnouncerState {
    ...
    public record Notification(NotificationStyle style, String text) {
        public Notification {
            style = style == null ? NotificationStyle.INFO : style;
        }
    }
    ...
    public static final class Builder {
        ...
        public Builder notification(String notification) {
            this.notification = notification == null ? null : new Notification(NotificationStyle.INFO, notification);
            return this;
        }
